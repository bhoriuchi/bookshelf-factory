	...
	function prepareSchema(schema) {
		...
		_.forEach(schema, function(tableSchema, tableName) {
			...
			_.forEach(tableSchema, function(colSchema, colName) {
				...
				// hasOne relation
				/*
				else if (colSchema.hasOwnProperty(CONST.hasOne) ||
						colSchema.hasOwnProperty(CONST.hasMany)) {
					
					// create the foreign key
					foreignKey = colSchema[CONST.foreignKey] || colName + '_' + useTableName + '_' + myPk.join('_');
