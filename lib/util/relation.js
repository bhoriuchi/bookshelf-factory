		...
		return Promise.each(relations, function(rel) {
			...
			if (typeof (relObj) === 'object' && relObj !== null) {
				...
				// check for hasMany relationship and update all models
					...
					var hasManyVer = models._schema[relData.targetTableName].hasOwnProperty(relData.foreignKey) ? false : true;
					...
					relData.targetTableName = (hasManyVer) ? relData.targetTableName + 'version' : relData.targetTableName;
