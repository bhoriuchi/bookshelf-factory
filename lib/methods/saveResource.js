...
module.exports = function(config) {
	...
	return function(obj, fetchOpts, jsonOpts) {
		...
		if (fetchOpts.hasOwnProperty('_skipPayloadCheck') && fetchOpts._skipPayloadCheck) {
			...
			// check payload
			payload = util.checkPayload(this.tableName, obj, method);
		}
			...
			return Bookshelf.transaction(function(t) {
				...
				.then(function(model) {
					...
					if (payload.payload.hasOwnProperty('child')) {
						...
						.save(child.payload, {transacting: t, method: method})
						.tap(function(model){
