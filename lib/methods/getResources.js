...
module.exports = function(config) {
	...
	return function(fetchOpts, jsonOpts) {
		...
		var parentSearchSQL   = this._parentSearchSQL;
		var childSearchSQL    = this._childSearchSQL;
		var keep              = this._keep;
		...
		return this.query(function(qb) {
			qb.whereRaw(parentSearchSQL);
		})
		.fetchAll(fetchOpts).then(function(results) {
