...
module.exports = function(config) {
	...
	return function(fetchOpts, jsonOpts) {
		...
		// set the bypass for pretty print. this is used for the getResource
		// function since it needs to return a single resource and not an 
	    //array with a single resource
		var ugly              = (jsonOpts.hasOwnProperty('_ugly') && jsonOpts._ugly) ?
				                true : false;
		...
		var v                 = utils.schema.getVersionedModel(schema, models._schema);
