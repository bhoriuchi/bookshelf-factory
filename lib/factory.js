...
module.exports = function(config) {
	...
	mods.schema       = schemaUtil;
	var relation      = require('./util/relation')(mods);
	mods.relation     = relation;
	...
	function create(schema) {
		...
		_.forEach(schema, function(tableSchema, tableName) {
			...
			// check for versioned object
			if (tableSchema.hasOwnProperty('_versioned')) {
				objProto.publish     = function() {
					console.log('i can be published');
				};
			}
